...
ggml_vulkan_available = ggml.GGML_USE_VULKAN

run_if_ggml_vulkan_available = pytest.mark.skipif(
    not ggml_vulkan_available,
    reason="Vulkan not available",
)

@run_if_ggml_vulkan_available
def test_vulkan():
    ...
    backend = ggml.ggml_backend_vk_init(0)
